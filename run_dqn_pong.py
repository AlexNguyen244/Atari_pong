...
num_frames = 1000000 # Number of times we play
batch_size = 32 # batch of plays at a time
gamma = 0.99
record_idx = 10000

replay_initial = 10000 # once this certain amount is stored in buffer we start learning
replay_buffer = ReplayBuffer(100000) # stores the reward, states, etc in to replay buffer
